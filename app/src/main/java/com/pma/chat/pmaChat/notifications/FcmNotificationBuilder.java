...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAABPZgF_o:APA91bGR0S-E84sEutQPF5fgAuwMpZp5cVZb9yU2gJOlH8nk7S2ssK4EegHB0db_wjKE8F_6f3rKBuRz8UViu1gEDTgOVvYCA302Nb7XUMLR2ej4YzUx37uZhHVBa-Y9pqExSveWgkN7";
    ...
    private static final String CONVERSATION_NAME = "converastion_name";
    ...
    public FcmNotificationBuilder conversationId(String conversationId){
        mConversationId = conversationId;
        return this;
    }

    public FcmNotificationBuilder conversationName(String conversationName){
        mConversationId = conversationName;
        return this;
    }
    ...
    private JSONObject getValidJsonBody() throws JSONException {
        ...
        jsonObjectData.put(CONVERSATION_ID, mConversationId);
        jsonObjectBody.put(CONVERSATION_NAME, mConversationName);
